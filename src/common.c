...
void init_header(struct header_struct *header) {
  ...
  header->adcount = header->nscount = header->ancount = header->qdcount =
      htons(0);
}
...
static enum {
  ...
  DEBUG_PRINT_TYPE_ad,
  DEBUG_PRINT_TYPE_cd,
  DEBUG_PRINT_TYPE_rcode,
  DEBUG_PRINT_TYPE_qdcount,
  DEBUG_PRINT_TYPE_ancount,
  DEBUG_PRINT_TYPE_nscount,
  DEBUG_PRINT_TYPE_arcount,
  DEBUG_PRINT_TYPE_type,
  DEBUG_PRINT_TYPE_class
} DEBUG_PRINT_TYPE;
